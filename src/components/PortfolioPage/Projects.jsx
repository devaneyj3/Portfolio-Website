        ...
        <section className='portfolio'>
            ...
            <div className='projects'>
                <section className='row'>
                    <a href="https://wunderlist-2.firebaseapp.com/" className="image featured"><img src={wonderlist} alt="Wonderlist-App"></img></a>             
                    <h3><a href="https://wunderlist-2.firebaseapp.com/">Wunderlist App</a></h3>
                    <p>This was a Lambda School sprint project using React to make a todo list
                        app.
                    </p>
                </section>
                <section className='row'>
                    <a href="https://devaneyj3.github.io/simon_game/" className="image featured"><img src={simon_game} alt="Simon Game" /></a>
                ...
                <section className='row'>
                    <a href="https://devaneyj3.github.io/Drum_Kit/" className="image featured"><img src={Drum_Kit} alt="Drum Kit" /></a>
